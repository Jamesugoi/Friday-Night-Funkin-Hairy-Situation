...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Hairy Situation Mod Team'],
			['Jamesugoi',			'jamesugoi',		'Creator and artist of the mod',					'https://twitter.com/Jamesugoi',		'0xFFFFFFFC'],
			['Astr',				'astr',				'Composer for the mod',								'https://twitter.com/_JRNSTR',			'0xFFFFF661'],
			[''],
			['Psych Engine Team'],
